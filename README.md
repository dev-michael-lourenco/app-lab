# APP GEO CONCESSIONARIA (DEALERSHIP)
...
# DADOS DA CONCESSIONARIA ENVIADO PELO CELULAR 
    # NOME
    # TELEFONE
    # EMAIL
    # LATITUDE  (VIA GPS)
...
# DETALHES SOBRE DENSIDADE DE IMAGENS ENTRE CELULARES E A NECESSIDADE DE 3 RESOLUÇÕES [OK]
